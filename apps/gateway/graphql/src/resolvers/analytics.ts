...
export const analyticsResolvers = {
  Query: {
    dashboardMetrics: requireStaff(async (
      _: any,
      ...
      try {
        ...
        const response = await context.dataSources.analyticsService.getDashboardMetrics(effectiveTenantId);
    ...
    learnerAnalytics: requireStaff(async (
      _: any,
    ...
    academicTrends: requireStaff(async (
      _: any,
      { 
        tenantId, 
        timeframe = '6months' 
