...
class BulkEnrollRequest(BaseModel):
    ...
    learner_ids: Annotated[List[StrictStr], Field(min_length=1, max_length=1000)] = Field(alias="learnerIds")
    expires_at: Optional[datetime] = Field(default=None, alias="expiresAt")
    metadata: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["tenantId", "courseId", "learnerIds", "expiresAt", "metadata"]
