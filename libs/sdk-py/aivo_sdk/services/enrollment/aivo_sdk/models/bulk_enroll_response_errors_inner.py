...
class BulkEnrollResponseErrorsInner(BaseModel):
    """
    BulkEnrollResponseErrorsInner
    """  # noqa: E501

    learner_id: StrictStr | None = Field(default=None, alias="learnerId")
    error: StrictStr | None = None
    message: StrictStr | None = None
    __properties: ClassVar[list[str]] = ["learnerId", "error", "message"]
