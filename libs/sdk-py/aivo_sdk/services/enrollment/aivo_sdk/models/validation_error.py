...
class ValidationError(BaseModel):
    ...
    error: StrictStr
    message: StrictStr
    validation_errors: List[ValidationErrorValidationErrorsInner] = Field(alias="validationErrors")
    __properties: ClassVar[List[str]] = ["error", "message", "validationErrors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validationErrors": [ValidationErrorValidationErrorsInner.from_dict(_item) for _item in obj["validationErrors"]] if obj.get("validationErrors") is not None else None
        })
        return _obj
