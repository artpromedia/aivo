...
class Enrollment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "tenantId", "learnerId", "courseId", "status", "enrolledAt", "startedAt", "completedAt", "expiresAt", "enrolledBy", "metadata", "createdAt", "updatedAt"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['enrolled', 'in_progress', 'completed', 'dropped', 'expired']):
            raise ValueError("must be one of enum values ('enrolled', 'in_progress', 'completed', 'dropped', 'expired')")
        return value
