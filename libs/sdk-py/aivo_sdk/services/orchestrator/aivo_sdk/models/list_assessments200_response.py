...
class ListAssessments200Response(BaseModel):
    """
    ListAssessments200Response
    """ # noqa: E501
    data: List[Assessment]
    total: StrictInt
    limit: StrictInt
    offset: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [Assessment.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "total": obj.get("total"),
            "limit": obj.get("limit"),
