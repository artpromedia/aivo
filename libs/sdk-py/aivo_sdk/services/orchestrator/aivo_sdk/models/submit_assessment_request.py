...
class SubmitAssessmentRequest(BaseModel):
    ...
    answers: list[SubmitAssessmentRequestAnswersInner]
    time_spent: StrictInt | None = Field(
        default=None, description="Time spent in minutes", alias="timeSpent"
    )
    __properties: ClassVar[list[str]] = ["answers", "timeSpent"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "answers": [
                    SubmitAssessmentRequestAnswersInner.from_dict(_item) for _item in obj["answers"]
                ]
