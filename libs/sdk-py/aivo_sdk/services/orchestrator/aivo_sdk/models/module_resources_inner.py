...
class ModuleResourcesInner(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["title", "url", "type"]
    ...
    def type_validate_enum(self, value):
        ...
        if value not in set(["pdf", "link", "code", "dataset"]):
            raise ValueError("must be one of enum values ('pdf', 'link', 'code', 'dataset')")
        return value
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"title": obj.get("title"), "url": obj.get("url"), "type": obj.get("type")}
        )
        return _obj
