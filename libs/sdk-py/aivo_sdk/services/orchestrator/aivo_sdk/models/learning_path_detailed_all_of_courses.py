...
class LearningPathDetailedAllOfCourses(BaseModel):
    ...
    unlock_conditions: Optional[LearningPathDetailedAllOfUnlockConditions] = Field(default=None, alias="unlockConditions")
    __properties: ClassVar[List[str]] = ["courseId", "course", "order", "isOptional", "unlockConditions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "course": Course.from_dict(obj["course"]) if obj.get("course") is not None else None,
            "order": obj.get("order"),
            "isOptional": obj.get("isOptional"),
            "unlockConditions": LearningPathDetailedAllOfUnlockConditions.from_dict(obj["unlockConditions"]) if obj.get("unlockConditions") is not None else None
        })
        return _obj
