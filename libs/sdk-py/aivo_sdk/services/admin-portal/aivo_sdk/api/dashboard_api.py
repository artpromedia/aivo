...
class DashboardApi:
    ...
    def get_tenant_summary(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant ID to get summary for")],
        ...
        :param tenant_id: Tenant ID to get summary for (required)
        :type tenant_id: str
        ...
        _param = self._get_tenant_summary_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    def get_tenant_summary_with_http_info(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant ID to get summary for")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
    ...
    @validate_call
    def get_tenant_summary_without_preload_content(
        self,
        tenant_id: Annotated[StrictStr, Field(description="Tenant ID to get summary for")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
    ...
    def _get_tenant_summary_serialize(
        self,
        tenant_id,
        _request_auth,
        _content_type,
