...
class UsageAnalytics(BaseModel):
    ...
    total_minutes_learned: StrictInt = Field(description="Total learning minutes in the specified range", alias="totalMinutesLearned")
    active_learners: UsageAnalyticsActiveLearners = Field(alias="activeLearners")
    average_session_length: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average learning session length in minutes", alias="averageSessionLength")
    completion_stats: Optional[UsageAnalyticsCompletionStats] = Field(default=None, alias="completionStats")
    subject_mix: List[UsageAnalyticsSubjectMixInner] = Field(description="Breakdown of learning time by subject", alias="subjectMix")
    trends: UsageAnalyticsTrends
    engagement: Optional[UsageAnalyticsEngagement] = None
    last_updated: datetime = Field(alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["tenantId", "range", "totalMinutesLearned", "activeLearners", "averageSessionLength", "completionStats", "subjectMix", "trends", "engagement", "lastUpdated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeLearners": UsageAnalyticsActiveLearners.from_dict(obj["activeLearners"]) if obj.get("activeLearners") is not None else None,
            "averageSessionLength": obj.get("averageSessionLength"),
            "completionStats": UsageAnalyticsCompletionStats.from_dict(obj["completionStats"]) if obj.get("completionStats") is not None else None,
            "subjectMix": [UsageAnalyticsSubjectMixInner.from_dict(_item) for _item in obj["subjectMix"]] if obj.get("subjectMix") is not None else None,
            "trends": UsageAnalyticsTrends.from_dict(obj["trends"]) if obj.get("trends") is not None else None,
            "engagement": UsageAnalyticsEngagement.from_dict(obj["engagement"]) if obj.get("engagement") is not None else None,
