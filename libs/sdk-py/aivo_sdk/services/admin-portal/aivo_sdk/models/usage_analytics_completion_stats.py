...
class UsageAnalyticsCompletionStats(BaseModel):
    """
    UsageAnalyticsCompletionStats
    """ # noqa: E501
    courses_completed: Optional[StrictInt] = Field(default=None, alias="coursesCompleted")
    modules_completed: Optional[StrictInt] = Field(default=None, alias="modulesCompleted")
    assessments_passed: Optional[StrictInt] = Field(default=None, alias="assessmentsPassed")
    __properties: ClassVar[List[str]] = ["coursesCompleted", "modulesCompleted", "assessmentsPassed"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "modulesCompleted": obj.get("modulesCompleted"),
            "assessmentsPassed": obj.get("assessmentsPassed")
        })
        return _obj
