...
class NamespacesOverviewStorageStats(BaseModel):
    ...
    total_storage_used: StrictInt | None = Field(
        default=None,
        description="Total storage used across all namespaces (MB)",
        alias="totalStorageUsed",
    )
    average_storage_per_namespace: StrictFloat | StrictInt | None = Field(
        default=None,
        description="Average storage per namespace (MB)",
        alias="averageStoragePerNamespace",
    )
    max_storage_used: StrictInt | None = Field(
        default=None,
        description="Maximum storage used by a single namespace (MB)",
        alias="maxStorageUsed",
    )
