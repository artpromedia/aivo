...
class SubscriptionDetailsPlan(BaseModel):
    ...
    price_per_seat: StrictFloat | StrictInt | None = Field(
        default=None, description="Price per seat per month", alias="pricePerSeat"
    )
    __properties: ClassVar[list[str]] = ["name", "tier", "features", "pricePerSeat"]

    @field_validator("tier")
    def tier_validate_enum(self, value):
        """Validates the enum"""
        ...
        _obj = cls.model_validate(
            {
                ...
                "pricePerSeat": obj.get("pricePerSeat"),
            }
        )
        return _obj
