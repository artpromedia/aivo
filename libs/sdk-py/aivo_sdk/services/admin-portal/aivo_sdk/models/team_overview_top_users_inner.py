...
class TeamOverviewTopUsersInner(BaseModel):
    """
    ...
    enrollments: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["userId", "name", "email", "role", "lastActive", "enrollments"]
