...
class BillingHistory(BaseModel):
    ...
    summary: Optional[BillingHistorySummary] = None
    webhooks_status: BillingHistoryWebhooksStatus = Field(alias="webhooksStatus")
    last_updated: datetime = Field(alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["tenantId", "invoices", "summary", "webhooksStatus", "lastUpdated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoices": [BillingHistoryInvoicesInner.from_dict(_item) for _item in obj["invoices"]] if obj.get("invoices") is not None else None,
            "summary": BillingHistorySummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None,
            "webhooksStatus": BillingHistoryWebhooksStatus.from_dict(obj["webhooksStatus"]) if obj.get("webhooksStatus") is not None else None,
