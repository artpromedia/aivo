...
class SubscriptionDetailsTrialInfo(BaseModel):
    """
    SubscriptionDetailsTrialInfo
    """  # noqa: E501

    is_trialing: StrictBool | None = Field(default=None, alias="isTrialing")
    trial_ends_at: datetime | None = Field(default=None, alias="trialEndsAt")
    days_remaining: StrictInt | None = Field(default=None, alias="daysRemaining")
    __properties: ClassVar[list[str]] = ["isTrialing", "trialEndsAt", "daysRemaining"]
