...
class TeamOverviewPendingInvitesByRole(BaseModel):
    """
    TeamOverviewPendingInvitesByRole
    """ # noqa: E501
    tenant_admin: Optional[StrictInt] = None
    instructor: Optional[StrictInt] = None
    learner: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["tenant_admin", "instructor", "learner"]
