...
class SubscriptionDetailsSeats(BaseModel):
    """
    SubscriptionDetailsSeats
    """  # noqa: E501

    current: StrictInt = Field(description="Current number of seats")
    included: StrictInt = Field(description="Seats included in base plan")
    additional: StrictInt = Field(description="Additional seats purchased")
    __properties: ClassVar[list[str]] = ["current", "included", "additional"]
