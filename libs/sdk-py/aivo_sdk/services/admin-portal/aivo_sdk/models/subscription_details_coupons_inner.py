...
class SubscriptionDetailsCouponsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["code", "discount", "validUntil", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'used', 'expired']):
            raise ValueError("must be one of enum values ('active', 'used', 'expired')")
        return value
