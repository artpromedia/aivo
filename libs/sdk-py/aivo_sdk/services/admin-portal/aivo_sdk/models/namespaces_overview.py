...
class NamespacesOverview(BaseModel):
    ...
    total_namespaces: StrictInt = Field(description="Total number of learner private-brain namespaces", alias="totalNamespaces")
    status_counts: NamespacesOverviewStatusCounts = Field(alias="statusCounts")
    storage_stats: Optional[NamespacesOverviewStorageStats] = Field(default=None, alias="storageStats")
    top_namespaces: Annotated[List[NamespacesOverviewTopNamespacesInner], Field(max_length=10)] = Field(description="Most active or largest namespaces", alias="topNamespaces")
    recent_activity: Optional[NamespacesOverviewRecentActivity] = Field(default=None, alias="recentActivity")
    health_summary: Optional[NamespacesOverviewHealthSummary] = Field(default=None, alias="healthSummary")
    last_updated: datetime = Field(alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["tenantId", "totalNamespaces", "statusCounts", "storageStats", "topNamespaces", "recentActivity", "healthSummary", "lastUpdated"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "statusCounts": NamespacesOverviewStatusCounts.from_dict(obj["statusCounts"]) if obj.get("statusCounts") is not None else None,
            "storageStats": NamespacesOverviewStorageStats.from_dict(obj["storageStats"]) if obj.get("storageStats") is not None else None,
            "topNamespaces": [NamespacesOverviewTopNamespacesInner.from_dict(_item) for _item in obj["topNamespaces"]] if obj.get("topNamespaces") is not None else None,
            "recentActivity": NamespacesOverviewRecentActivity.from_dict(obj["recentActivity"]) if obj.get("recentActivity") is not None else None,
            "healthSummary": NamespacesOverviewHealthSummary.from_dict(obj["healthSummary"]) if obj.get("healthSummary") is not None else None,
