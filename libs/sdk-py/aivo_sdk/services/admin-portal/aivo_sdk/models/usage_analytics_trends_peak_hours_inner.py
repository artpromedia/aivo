...
class UsageAnalyticsTrendsPeakHoursInner(BaseModel):
    """
    UsageAnalyticsTrendsPeakHoursInner
    """  # noqa: E501

    hour: Annotated[int, Field(le=23, strict=True, ge=0)] | None = None
    sessions: StrictInt | None = None
    __properties: ClassVar[list[str]] = ["hour", "sessions"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"hour": obj.get("hour"), "sessions": obj.get("sessions")})
        return _obj
