...
class TenantSettings(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "features": TenantSettingsFeatures.from_dict(obj["features"]) if obj.get("features") is not None else None,
            "branding": TenantSettingsBranding.from_dict(obj["branding"]) if obj.get("branding") is not None else None,
            "notifications": TenantSettingsNotifications.from_dict(obj["notifications"]) if obj.get("notifications") is not None else None
        })
        return _obj
