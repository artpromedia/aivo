...
class Tenant(BaseModel):
    ...
    status: StrictStr
    plan: StrictStr
    max_users: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="maxUsers")
    max_seats: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="maxSeats")
    trial_ends_at: Optional[datetime] = Field(default=None, alias="trialEndsAt")
    created_at: datetime = Field(alias="createdAt")
    updated_at: datetime = Field(alias="updatedAt")
    __properties: ClassVar[List[str]] = ["id", "name", "slug", "description", "logo", "website", "status", "plan", "maxUsers", "maxSeats", "trialEndsAt", "createdAt", "updatedAt"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['active', 'inactive', 'trial', 'suspended']):
            raise ValueError("must be one of enum values ('active', 'inactive', 'trial', 'suspended')")
        return value
