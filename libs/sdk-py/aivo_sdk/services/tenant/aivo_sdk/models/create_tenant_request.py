...
class CreateTenantRequest(BaseModel):
    ...
    plan: StrictStr
    max_users: Optional[Annotated[int, Field(le=10000, strict=True, ge=1)]] = Field(default=None, alias="maxUsers")
    __properties: ClassVar[List[str]] = ["name", "slug", "description", "website", "plan", "maxUsers"]
