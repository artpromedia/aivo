...
class TenantSettingsBranding(BaseModel):
    """
    TenantSettingsBranding
    """  # noqa: E501

    primary_color: Annotated[str, Field(strict=True)] | None = Field(
        default=None, alias="primaryColor"
    )
    secondary_color: Annotated[str, Field(strict=True)] | None = Field(
        default=None, alias="secondaryColor"
    )
    logo: StrictStr | None = None
    favicon: StrictStr | None = None
    __properties: ClassVar[list[str]] = ["primaryColor", "secondaryColor", "logo", "favicon"]

    @field_validator("primary_color")
    def primary_color_validate_regular_expression(self, value):
    ...
    def secondary_color_validate_regular_expression(self, value):
        """Validates the regular expression"""
        if value is None:
            return value
