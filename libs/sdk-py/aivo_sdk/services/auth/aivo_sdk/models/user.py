...
class User(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "email", "firstName", "lastName", "role", "tenantId", "status", "avatar", "lastLoginAt", "createdAt", "updatedAt"]

    @field_validator('role')
    def role_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['super_admin', 'tenant_admin', 'instructor', 'learner']):
            raise ValueError("must be one of enum values ('super_admin', 'tenant_admin', 'instructor', 'learner')")
        return value
