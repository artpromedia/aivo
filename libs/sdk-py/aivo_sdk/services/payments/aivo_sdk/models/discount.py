...
class Discount(BaseModel):
    ...
    coupon_id: StrictStr | None = Field(default=None, alias="couponId")
    coupon_code: StrictStr | None = Field(default=None, alias="couponCode")
    discount_type: StrictStr | None = Field(default=None, alias="discountType")
    discount_value: StrictFloat | StrictInt | None = Field(default=None, alias="discountValue")
    __properties: ClassVar[list[str]] = ["couponId", "couponCode", "discountType", "discountValue"]
