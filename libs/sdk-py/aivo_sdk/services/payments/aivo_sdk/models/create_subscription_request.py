...
class CreateSubscriptionRequest(BaseModel):
    ...
    trial_period_days: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="trialPeriodDays")
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "planId", "quantity", "trialPeriodDays", "couponCode", "paymentMethodId", "metadata"]
