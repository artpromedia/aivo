...
class Invoice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "subscriptionId", "tenantId", "invoiceNumber", "status", "amountDue", "amountPaid", "currency", "dueDate", "paidAt", "periodStart", "periodEnd", "downloadUrl", "lineItems", "createdAt"]
