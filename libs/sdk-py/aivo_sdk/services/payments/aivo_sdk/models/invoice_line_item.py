...
class InvoiceLineItem(BaseModel):
    ...
    quantity: StrictInt
    unit_amount: StrictInt = Field(description="Amount in cents", alias="unitAmount")
    amount: StrictInt = Field(description="Total amount in cents")
    __properties: ClassVar[list[str]] = ["description", "quantity", "unitAmount", "amount"]
