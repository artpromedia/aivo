...
class PaymentMethodBankAccount(BaseModel):
    ...
    bank_name: StrictStr | None = Field(default=None, alias="bankName")
    last4: StrictStr | None = None
    account_type: StrictStr | None = Field(default=None, alias="accountType")
    __properties: ClassVar[list[str]] = ["bankName", "last4", "accountType"]

    @field_validator("account_type")
    def account_type_validate_enum(self, value):
        """Validates the enum"""
        if value is None:
            return value
