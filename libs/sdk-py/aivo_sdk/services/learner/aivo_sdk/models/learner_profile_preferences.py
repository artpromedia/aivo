...
class LearnerProfilePreferences(BaseModel):
    ...
    notifications_enabled: Optional[StrictBool] = Field(default=True, alias="notificationsEnabled")
    email_digest: Optional[StrictBool] = Field(default=True, alias="emailDigest")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notificationsEnabled": obj.get("notificationsEnabled") if obj.get("notificationsEnabled") is not None else True,
            "emailDigest": obj.get("emailDigest") if obj.get("emailDigest") is not None else True,
