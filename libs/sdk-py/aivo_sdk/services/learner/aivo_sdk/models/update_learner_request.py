...
class UpdateLearnerRequest(BaseModel):
    ...
    first_name: Annotated[str, Field(min_length=1, strict=True, max_length=50)] | None = Field(
        default=None, alias="firstName"
    )
    last_name: Annotated[str, Field(min_length=1, strict=True, max_length=50)] | None = Field(
        default=None, alias="lastName"
    )
    status: StrictStr | None = None
    timezone: StrictStr | None = None
    language: StrictStr | None = None
    department: Annotated[str, Field(strict=True, max_length=100)] | None = None
    job_title: Annotated[str, Field(strict=True, max_length=100)] | None = Field(
        default=None, alias="jobTitle"
    )
