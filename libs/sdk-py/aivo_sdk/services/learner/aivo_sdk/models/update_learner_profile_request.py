...
class UpdateLearnerProfileRequest(BaseModel):
    ...
    preferences: Optional[UpdateLearnerProfileRequestPreferences] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bio": obj.get("bio"),
            "preferences": UpdateLearnerProfileRequestPreferences.from_dict(obj["preferences"]) if obj.get("preferences") is not None else None,
