        ...
        _obj = cls.model_validate(
            {
                ...
                "bio": obj.get("bio"),
                "preferences": LearnerProfilePreferences.from_dict(obj["preferences"])
                if obj.get("preferences") is not None
                else None,
                "skills": [LearnerProfileSkillsInner.from_dict(_item) for _item in obj["skills"]]
                if obj.get("skills") is not None
                else None,
                "goals": [LearnerProfileGoalsInner.from_dict(_item) for _item in obj["goals"]]
