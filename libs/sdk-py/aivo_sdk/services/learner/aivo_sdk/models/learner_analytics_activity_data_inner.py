...
class LearnerAnalyticsActivityDataInner(BaseModel):
    """
    ...
    sessions_count: Optional[StrictInt] = Field(default=None, alias="sessionsCount")
    __properties: ClassVar[List[str]] = ["date", "minutesLearned", "sessionsCount"]
