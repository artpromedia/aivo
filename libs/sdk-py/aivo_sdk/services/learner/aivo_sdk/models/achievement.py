...
class Achievement(BaseModel):
    ...
    badge_url: StrictStr | None = Field(default=None, alias="badgeUrl")
    ...
    def type_validate_enum(self, value):
        """Validates the enum"""
        if value not in set(
            ["course_completion", "streak", "skill_mastery", "certification", "milestone"]
        ):
            raise ValueError(
                "must be one of enum values ('course_completion', 'streak', 'skill_mastery', 'certification', 'milestone')"
            )
        return value
