...
class Achievement(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "learnerId", "type", "title", "description", "iconUrl", "badgeUrl", "points", "metadata", "earnedAt"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['course_completion', 'streak', 'skill_mastery', 'certification', 'milestone']):
            raise ValueError("must be one of enum values ('course_completion', 'streak', 'skill_mastery', 'certification', 'milestone')")
        return value
