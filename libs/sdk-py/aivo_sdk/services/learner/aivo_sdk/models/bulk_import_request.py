...
class BulkImportRequest(BaseModel):
    ...
    learners: Annotated[List[CreateLearnerRequest], Field(min_length=1, max_length=1000)]
    __properties: ClassVar[List[str]] = ["tenantId", "learners"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "learners": [CreateLearnerRequest.from_dict(_item) for _item in obj["learners"]] if obj.get("learners") is not None else None
        })
        return _obj
