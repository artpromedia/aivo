...
class BulkImportResponse(BaseModel):
    ...
    failed: StrictInt
    total: StrictInt
    errors: Optional[List[BulkImportResponseErrorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "errors": [BulkImportResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
