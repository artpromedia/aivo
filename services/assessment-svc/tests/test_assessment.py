...
from app.enums import LevelType, SubjectType
...
def mock_event_service():
    ...
    with (
        patch.object(
            event_service, "publish_session_started", new_callable=AsyncMock
        ) as mock_session,
        patch.object(
            event_service, "publish_question_answered", new_callable=AsyncMock
        ) as mock_question,
        patch.object(
            event_service, "publish_baseline_complete", new_callable=AsyncMock
        ) as mock_complete,
    ):
        yield {
...
class TestBaselineAssessment:
    ...
    def test_start_baseline_assessment(self, mock_event_service):
        ...
        request_data = {"user_id": "test-user-123", "subject": "mathematics"}
    ...
    def test_start_assessment_invalid_subject(self):
        ...
        request_data = {"user_id": "test-user-123", "subject": "invalid_subject"}
    ...
    def test_submit_baseline_answer(self, mock_event_service):
        ...
        start_request = {"user_id": "test-user-123", "subject": "mathematics"}
        ...
        # Submit answer
        answer_request = {"session_id": session_id, "question_id": question_id, "answer": "A"}
    ...
    def test_submit_answer_invalid_session(self):
        ...
        answer_request = {"session_id": "invalid-session", "question_id": "q1", "answer": "A"}
    ...
    def test_assessment_convergence(self):
        ...
        while question_count <= 10:  # Safety limit
            ...
            evaluation, next_question, is_complete = assessment_engine.submit_answer(
                session.session_id, current_question.question_id, answer
            )
...
class TestErrorHandling:
    ...
    def test_session_expiration(self, mock_event_service):
        ...
        answer_request = {"session_id": session_id, "question_id": "any-question", "answer": "A"}
