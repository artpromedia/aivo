...
class TestCacheService:
    ...
    async def test_cache_json_serialization(self):
        ...
        complex_data = {
            ...
            "metrics": [
                {"name": "api_calls", "value": 1000},
                {"name": "storage", "value": 250.5}
            ],
            "metadata": {
...
class TestCacheIntegrationPatterns:
    ...
    async def test_cache_write_through_pattern(self):
        ...
        tenant_id = "tenant_123"
        updated_data = {"name": "Updated Tenant", "status": "active"}
...
class TestCacheReliability:
    ...
    async def test_cache_failover_graceful_degradation(self):
        ...
        # Mock cache failure
        with patch.object(cache_service, 'get', side_effect=Exception("Cache unavailable")), \
