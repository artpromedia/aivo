...
class TestDownstreamServiceContracts:
    ...
    async def test_tenant_service_contract(self):
        ...
        expected_response = {
            ...
            "settings": {
                "features_enabled": ["analytics", "workflows", "api_access"]
            }
        }
...
class TestDataTransformation:
    ...
    async def test_summary_data_aggregation(self):
        ...
        document_data = {
            ...
            "recent_activity": [
                {"type": "upload", "count": 15},
                {"type": "approval", "count": 8}
            ]
        }
        ...
        with patch.object(service_aggregator, '_get_tenant_info', return_value=tenant_data), \
...
class TestCacheIntegration:
    ...
    async def test_cache_hit_avoids_service_call(self):
        ...
        with patch.object(cache_service, 'get', return_value=cached_summary), \
...
class TestErrorRecovery:
    ...
    async def test_partial_failure_recovery(self):
        ...
        with patch.object(service_aggregator, '_get_tenant_info') as mock_tenant, \
            ...
            mock_tenant.return_value = {
                "name": "Resilient Tenant",
                "status": "active"
            }
            
            # User service succeeds
            mock_users.return_value = {
                "statistics": {"total_users": 25, "active_30d": 20}
            }
