...
class TestAPIEndpoints:
    ...
    def test_subscription_endpoint(self, mock_get_subscription, client, subscription_contract_fixture):
    ...
    def test_billing_history_endpoint(self, mock_get_billing, client, billing_history_contract_fixture):
...
class TestServiceIntegration:
    ...
    async def test_partial_service_failure(self, mock_tenant_id):
        ...
        with patch.object(service_aggregator, '_get_tenant_info') as mock_tenant, \
