...
class ChatMessage(Base):
    ...
    moderation_logs = relationship("ModerationLog", back_populates="message",
                                 cascade="all, delete-orphan")
    audit_entries = relationship("AuditEntry", back_populates="message",
                               cascade="all, delete-orphan")
...
class ModerationLog(Base):
    ...
    # Action taken
    action_taken: Mapped[ModerationAction] = mapped_column(SQLEnum(ModerationAction), 
                                                         nullable=False)
...
class ParentalControl(Base):
    ...
    # AI Tutor controls
    ai_tutor_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    ai_tutor_time_limits: Mapped[Optional[Dict[str, Any]]] = mapped_column(JSON, 
                                                                          nullable=True)
