...
class Settings(BaseSettings):
    ...
    service_name: str = Field(
        default="model-dispatch-svc", description="Service name"
    )
    ...
    auto_reload_config: bool = Field(
        default=True, description="Auto-reload configuration changes"
    )
    ...
    override_cache_ttl_seconds: int = Field(
        default=3600, description="Teacher override cache TTL"
    )
