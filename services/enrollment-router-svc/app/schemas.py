...
from .models import EnrollmentStatus, ProvisionSource
...
class EnrollmentContext(BaseModel):
    ...
    tenant_id: int | None = Field(None, description="District/tenant ID")
    guardian_id: str | None = Field(None, description="Parent/guardian ID")
    source: str | None = Field(None, description="Enrollment source")
