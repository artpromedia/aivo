...
class TestEnrollmentAPI:
    ...
    @pytest.mark.asyncio
    async def test_get_enrollment_decision(
        self, 
        client, 
        enrollment_decision
    ):
    ...
    @pytest.mark.asyncio
    async def test_list_enrollment_decisions(
        self, 
        client, 
        enrollment_decision
    ):
        ...
        found_decision = next(
            (d for d in data if d["decision_id"] == enrollment_decision.id), 
            None
        )
    ...
    @pytest.mark.asyncio
    async def test_list_enrollment_decisions_with_tenant_filter(
        self, 
        client, 
        enrollment_decision
    ):
    ...
    @pytest.mark.asyncio
    async def test_list_enrollment_decisions_with_guardian_filter(
        self, 
        client
    ):
...
class TestDistrictSeatAPI:
    ...
    @pytest.mark.asyncio
    async def test_get_district_allocation(
        self, 
        client, 
        district_allocation
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_district_allocation(
        self, 
        client, 
        district_allocation
    ):
        ...
        response = await client.put(
            f"/districts/{district_allocation.tenant_id}/seats", 
            json=request_data
        )
    ...
    @pytest.mark.asyncio
    async def test_list_district_allocations(
        self, 
        client, 
        district_allocation
    ):
        ...
        found_allocation = next(
            (a for a in data if a["tenant_id"] == district_allocation.tenant_id), 
            None
        )
    ...
    @pytest.mark.asyncio
    async def test_list_active_district_allocations_only(
        self, 
        client, 
        district_allocation
    ):
