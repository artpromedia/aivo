...
class TestEnrollmentContextValidation:
    ...
    @pytest.mark.asyncio
    async def test_enrollment_requires_tenant_or_guardian_id(
        self, 
        sample_learner_profile
    ):
    ...
    @pytest.mark.asyncio
    async def test_enrollment_allows_tenant_id_only(
        self, 
        sample_learner_profile
    ):
    ...
    @pytest.mark.asyncio
    async def test_enrollment_allows_guardian_id_only(
        self, 
        sample_learner_profile
    ):
    ...
    @pytest.mark.asyncio
    async def test_enrollment_allows_both_tenant_and_guardian_id(
        self, 
        sample_learner_profile
    ):
