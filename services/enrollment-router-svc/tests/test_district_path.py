...
from app.services import EnrollmentRouterService, DistrictSeatService
...
class TestDistrictEnrollmentPath:
    ...
    @pytest.mark.asyncio
    async def test_seat_reservation_updates_allocation(
        self, 
        db_session, 
        district_allocation
    ):
    ...
    @pytest.mark.asyncio
    async def test_cannot_reserve_more_seats_than_available(
        self, 
        db_session, 
        district_allocation
    ):
