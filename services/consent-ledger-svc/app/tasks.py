    ...
    try:
        ...
        async def _process_export():
            async with get_async_session() as session:
                ...
                # Process the export
                export_request = await export_service.process_export_request(UUID(request_id))
                ...
                return {
                    ...
                    "completed_at": export_request.completed_at.isoformat()
        ...
        async def _mark_failed():
            async with get_async_session() as session:
                ...
                if deletion_request:
                    ...
                    deletion_request.error_message = error_message
                    await session.commit()
        ...
        async def _cleanup():
            async with get_async_session() as session:
                ...
                stmt = (
                    ...
                    .where(DataExportRequest.download_expires_at < datetime.utcnow())
                    .where(DataExportRequest.completed_at < cutoff_date)
                )
        ...
        async def _check_overdue():
            async with get_async_session() as session:
                ...
                warning_stmt = (
                    ...
                    .where(DataExportRequest.requested_at < warning_date)
                    .where(DataExportRequest.requested_at > overdue_date)
                )
