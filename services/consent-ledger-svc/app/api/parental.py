...
from app.models import ParentalRight, ParentalRightStatus
...
async def initiate_parental_verification(
    ...
    try:
        ...
        background_tasks.add_task(
            parental_service.send_verification_email,
            parental_right.id
        )
...
async def resend_verification(
    ...
    try:
        ...
        if not success:
            raise HTTPException(status_code=404, detail="Parental right not found or already verified")
