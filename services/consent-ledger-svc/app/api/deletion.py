...
from app.models import DeletionRequest, DeletionStatus
...
async def retry_failed_deletion(
    deletion_id: UUID,
    background_tasks: BackgroundTasks,
    systems: Optional[List[str]] = Query(None, description="Specific systems to retry"),
    delete_service: CascadeDeleteService = Depends(get_cascade_delete_service)
):
    """
