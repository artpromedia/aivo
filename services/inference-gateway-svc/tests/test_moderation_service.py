...
from app.enums import ModerationResult
...
class TestModerationService:
    ...
    async def test_moderate_safe_content(self, mock_openai_client):
        ...
        mock_openai_client.moderations.create.return_value.results = [
            type('MockResult', (), {
                'flagged': False,
                'category_scores': type('MockScores', (), {
                    'model_dump': lambda: {'harassment': 0.1, 'hate': 0.05}
                })()
            })()
        ]
    ...
    async def test_moderate_harmful_content(self, mock_openai_client):
        ...
        mock_openai_client.moderations.create.return_value.results = [
            type('MockResult', (), {
                'flagged': True,
                'category_scores': type('MockScores', (), {
                    'model_dump': lambda: {'harassment': 0.9, 'hate': 0.8}
                })()
            })()
        ]
    ...
    async def test_moderate_with_custom_threshold(self, mock_openai_client):
        ...
        mock_openai_client.moderations.create.return_value.results = [
            type('MockResult', (), {
                'flagged': True,
                'category_scores': type('MockScores', (), {
                    'model_dump': lambda: {'harassment': 0.7, 'hate': 0.6}
                })()
            })()
        ]
