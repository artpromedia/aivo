...
class TestCrdtManager:
    ...
    def sample_document(self):
        ...
        doc_id = str(uuid4())
        document = {"id": doc_id, "content": sample_iep_data.copy()}
    ...
    def test_apply_insert_operation(self, sample_document):
        ...
        assert (
            crdt_manager.documents[doc_id]["content"]["goals"][0]["title"]
            == sample_goal_data["title"]
        )
    ...
    async def test_publish_iep_created_event(self):
        ...
        with patch("httpx.AsyncClient.post") as mock_post:
            ...
            await event_service.publish_event(
                event_type=EventType.IEP_CREATED, iep_id=str(uuid4()), data=sample_iep_data
            )
...
class TestIntegrationWorkflow:
    ...
    async def test_concurrent_editing_scenario(self):
        ...
        # Create document
        crdt_manager.create_document(doc_id, sample_iep_data.copy())
