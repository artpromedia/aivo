...
class EventService:
        ...
        try:
            ...
            async with httpx.AsyncClient() as client:
                response = await client.post(
                    self.endpoint, json=event_payload, timeout=self.timeout
                )
    ...
    async def publish_iep_created(
        self, iep_id: str, student_id: str, created_by: str, student_name: str, school_year: str
    ) -> bool:
    ...
    async def publish_iep_updated(
        self, iep_id: str, student_id: str, status: str, updated_by: str, changes: list[str]
    ) -> bool:
    ...
    async def publish_iep_submitted(
        self, iep_id: str, student_id: str, submitted_by: str, approval_request_id: str
    ) -> bool:
    ...
    async def publish_iep_approved(
        self, iep_id: str, student_id: str, approved_by: list[str], approval_count: int
    ) -> bool:
    ...
    async def publish_goal_added(
        self, iep_id: str, goal_id: str, student_id: str, added_by: str, goal_type: str
    ) -> bool:
        ...
        return await self.publish_event(
            ...
            resource_id=iep_id,
            user_id=added_by,
            data={"student_id": student_id, "goal_id": goal_id, "goal_type": goal_type},
        )

    async def publish_goal_updated(
        self, iep_id: str, goal_id: str, student_id: str, updated_by: str, changes: list[str]
    ) -> bool:
        ...
        return await self.publish_event(
            ...
            resource_id=iep_id,
            user_id=updated_by,
            data={"student_id": student_id, "goal_id": goal_id, "changes": changes},
        )
