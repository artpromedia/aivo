...
class TestLearnerAPI:
    ...
    @pytest.mark.asyncio
    async def test_create_learner_api(self, client: AsyncClient, sample_guardian: Guardian):
    ...
    @pytest.mark.asyncio
    async def test_get_learner_api(self, client: AsyncClient, sample_guardian: Guardian):
    ...
    async def test_get_learners_by_guardian_api(
        self, client: AsyncClient, sample_guardian: Guardian
    ):
    ...
    @pytest.mark.asyncio
    async def test_update_learner_api(self, client: AsyncClient, sample_guardian: Guardian):
        ...
        # Update learner
        update_data = {"first_name": "Updated", "grade_current": 5}
    ...
    async def test_assign_teacher_api(
        self, client: AsyncClient, sample_guardian: Guardian, sample_teacher: Teacher
    ):
        ...
        # Assign teacher
        assignment_data = {"teacher_id": sample_teacher.id, "assigned_by": "api_admin"}

        response = await client.post(f"/learners/{learner_id}/teachers", json=assignment_data)
    ...
    async def test_assign_multiple_teachers_api(
        ...
        response = await client.post(f"/learners/{learner_id}/teachers/bulk", json=assignment_data)
    ...
    async def test_remove_teacher_api(
        ...
        assignment_data = {"teacher_id": sample_teacher.id}
        await client.post(f"/learners/{learner_id}/teachers", json=assignment_data)

        # Remove teacher
        response = await client.delete(f"/learners/{learner_id}/teachers/{sample_teacher.id}")
    ...
    async def test_assign_duplicate_teacher_api(
        ...
        response1 = await client.post(f"/learners/{learner_id}/teachers", json=assignment_data)
        assert response1.status_code == 201

        # Assign same teacher again (should fail)
        response2 = await client.post(f"/learners/{learner_id}/teachers", json=assignment_data)
...
class TestTeacherAPI:
    ...
    @pytest.mark.asyncio
    async def test_create_teacher_api(self, client: AsyncClient, sample_tenant: Tenant):
