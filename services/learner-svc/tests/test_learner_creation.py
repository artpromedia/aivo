...
from app.models import Learner, Guardian, Tenant, PrivateBrainRequest, ProvisionSource
...
class TestLearnerCreation:
    ...
    @pytest.mark.asyncio
    async def test_create_learner_with_guardian_only(self, db_session: AsyncSession, sample_guardian: Guardian):
