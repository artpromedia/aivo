...
from sqlalchemy import Column, Integer, String, DateTime, Date, ForeignKey, Enum, Table
...
class Learner(Base):
    ...
    grade_current: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    ...
    teachers: Mapped[List["Teacher"]] = relationship(
        "Teacher",
        secondary=learner_teacher_association,
