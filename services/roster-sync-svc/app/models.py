...
class District(Base):
    ...
    sis_id: Mapped[str | None] = mapped_column(String(255), index=True)
    state_id: Mapped[str | None] = mapped_column(String(255), index=True)
    nces_id: Mapped[str | None] = mapped_column(String(255), index=True)
...
class School(Base):
    ...
    state_id: Mapped[str | None] = mapped_column(String(255), index=True)
    nces_id: Mapped[str | None] = mapped_column(String(255), index=True)
    low_grade: Mapped[str | None] = mapped_column(String(10))
    high_grade: Mapped[str | None] = mapped_column(String(10))
    ...
    __table_args__ = (
        UniqueConstraint(
            "district_id", "external_id", name="uq_school_district_external"
        ),
    )
...
class User(Base):
    ...
    grade_level: Mapped[str | None] = mapped_column(String(10))
    ...
    scim_id: Mapped[str | None] = mapped_column(String(255), index=True)
    scim_error: Mapped[str | None] = mapped_column(Text)
    scim_last_sync: Mapped[datetime | None] = mapped_column(DateTime)
    ...
    __table_args__ = (
        UniqueConstraint(
            "district_id", "external_id", name="uq_user_district_external"
        ),
...
class Course(Base):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=False)
    course_code: Mapped[str | None] = mapped_column(String(100), index=True)
    course_number: Mapped[str | None] = mapped_column(String(100))
    ...
    __table_args__ = (
        UniqueConstraint(
            "district_id", "external_id", name="uq_course_district_external"
        ),
    )
...
class Class(Base):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=False)
    class_code: Mapped[str | None] = mapped_column(String(100), index=True)
    ...
    # Term information
    term_name: Mapped[str | None] = mapped_column(String(255))
    term_start_date: Mapped[datetime | None] = mapped_column(DateTime)
    term_end_date: Mapped[datetime | None] = mapped_column(DateTime)

    # Primary teacher
    primary_teacher_id: Mapped[uuid.UUID | None] = mapped_column(
...
class ConnectorConfig(Base):
    ...
    credentials: Mapped[dict[str, Any] | None] = mapped_column(JSON)
