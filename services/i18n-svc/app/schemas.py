...
class TranslationCreate(BaseModel):
    ...
    context: Optional[str] = Field(None, description="Context for the translation")
    description: Optional[str] = Field(None, description="Description for translators")


class TranslationUpdate(BaseModel):
    """Schema for updating an existing translation."""
    value: Optional[str] = Field(None, min_length=1, description="New translation value")
    context: Optional[str] = Field(None, description="Updated context")
...
class LocaleConfigCreate(BaseModel):
    ...
    fallback_locale: Optional[str] = Field(None, description="Fallback locale")
...
class BulkImportRequest(BaseModel):
    ...
    approve_all: bool = Field(False, description="Auto-approve all imported translations")
...
class SearchRequest(BaseModel):
    ...
    locale: Optional[str] = Field(None, description="Filter by locale")
...
class AccessibilityAuditRequest(BaseModel):
    ...
    translation_ids: Optional[List[UUID]] = None
    locale: Optional[str] = None
    audit_type: str = Field("automated", description="Type of audit")
    auditor_id: Optional[str] = None
    force_reaudit: bool = Field(False, description="Force re-audit of already audited translations")
