...
class TestSubscriptionService:
    ...
    @pytest.mark.asyncio
    async def test_create_checkout_session(self, subscription_service, db_session, mock_stripe_service):
        ...
        subscription = await subscription_service.get_subscription_by_id(db_session, subscription_id)
