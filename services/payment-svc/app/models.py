...
class Subscription(Base):
    ...
    guardian_id: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    ...
    )  # Base amount per seat
    discounted_amount: Mapped[Decimal | None] = mapped_column(Numeric(10, 2), nullable=True)
    ...
    discount_info: Mapped[dict[str, Any] | None] = mapped_column(JSON, nullable=True)
...
class PaymentMethod(Base):
    ...
    brand: Mapped[str | None] = mapped_column(String(50), nullable=True)  # visa, mastercard, etc.
    ...
    subscription: Mapped["Subscription"] = relationship(
        "Subscription", back_populates="payment_methods"
    )
...
class DiscountRule(Base):
    ...
    plan_type: Mapped[PlanType | None] = mapped_column(SQLEnum(PlanType), nullable=True)

    # Discount amount
    percentage: Mapped[Decimal | None] = mapped_column(Numeric(5, 2), nullable=True)  # 0-100
