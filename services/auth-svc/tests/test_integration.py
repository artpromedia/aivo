...
class TestCompleteWorkflows:
    ...
    def test_complete_guardian_flow(self, client):
        ...
        # 1. Register guardian
        register_response = client.post("/api/v1/auth/register-guardian", json={
    ...
    def test_complete_invitation_flow(self, client):
        ...
        admin_register = client.post("/api/v1/auth/register-guardian", json={
    ...
    def test_staff_login_with_tenant(self, client):
        ...
        tenant_id = str(uuid.uuid4())
        staff_login_response = client.post("/api/v1/auth/login-staff", json={
            "email": "staff.flow@example.com",
            "password": "StaffPass123!",
            "tenant_id": tenant_id
        })
    ...
    def test_multiple_user_sessions(self, client):
        ...
        guardian1_response = client.post("/api/v1/auth/register-guardian", json={
        ...
        guardian2_response = client.post("/api/v1/auth/register-guardian", json={
        ...
        profile1_response = client.get(
            "/api/v1/auth/me",
            headers={"Authorization": f"Bearer {guardian1_token}"}
        )
        
        profile2_response = client.get(
            "/api/v1/auth/me",
            headers={"Authorization": f"Bearer {guardian2_token}"}
        )
    ...
    def test_error_handling_comprehensive(self, client):
        ...
        invalid_register = client.post("/api/v1/auth/register-guardian", json={
        ...
        invalid_refresh = client.post("/api/v1/auth/refresh", json={
