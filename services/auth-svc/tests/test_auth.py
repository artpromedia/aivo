...
from app.models import User, RefreshToken, InviteToken
from app.security import create_password_hash, create_invite_token
...
class TestUserRegistration:
    ...
    def test_register_guardian_success(self, client):
        ...
        response = client.post("/api/v1/auth/register-guardian", json={
    ...
    def test_register_guardian_duplicate_email(self, client):
        ...
        # First registration
        client.post("/api/v1/auth/register-guardian", json={
            "email": "guardian@example.com",
            "password": "SecurePass123!",
            "first_name": "John",
            "last_name": "Doe",
...
class TestStaffLogin:
    ...
    def test_staff_login_success(self, client):
        ...
        pytest.skip("Staff creation flow requires admin/staff permissions not available through guardian registration")
...
class TestInviteFlow:
    ...
    def test_invite_teacher_success(self, client):
        ...
        pytest.skip("Teacher invitation requires staff/admin permissions not available through guardian registration")
