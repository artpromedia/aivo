...
class Settings(BaseSettings):
    ...
    # Index settings
    lessons_index: str = Field(default="lessons", description="Lessons index name")
    coursework_index: str = Field(default="coursework", description="Coursework index name")
    learners_index: str = Field(default="learners", description="Learners index name")
    ...
    # RBAC settings
    enable_rbac: bool = Field(default=True, description="Enable RBAC filtering")
    ...
    # Search settings
    default_search_size: int = Field(default=20, description="Default search result size")
    max_search_size: int = Field(default=100, description="Maximum search result size")
    search_timeout_seconds: int = Field(default=30, description="Search timeout in seconds")
    suggestion_size: int = Field(default=5, description="Number of suggestions to return")
