...
class Approval(Base):
    ...
    participants = relationship(
        "ApprovalParticipant", back_populates="approval", cascade="all, delete-orphan"
    )
    decisions = relationship(
        "ApprovalDecision", back_populates="approval", cascade="all, delete-orphan"
    )
    notifications = relationship(
        "ApprovalNotification", back_populates="approval", cascade="all, delete-orphan"
    )
    ...
    def approval_progress(self) -> dict[str, Any]:
        ...
        return {
            ...
            "completion_percentage": (approved_count / total_participants * 100)
...
class ApprovalDecision(Base):
    ...
    participant_id = Column(
        UUID(as_uuid=True), ForeignKey("approval_participants.id"), nullable=False
    )
