...
from .models import Approval, ApprovalParticipant, ApprovalNotification
...
class NotificationService:
    ...
    async def send_approval_notification(
        ...
        try:
            ...
            participant.notified_at = datetime.now(timezone.utc)
    ...
    async def send_completion_notification(
        self,
        approval: Approval,
        to_participants: bool = True,
        to_creator: bool = True
    ) -> bool:
        ...
        try:
            ...
            if to_creator:
                ...
                if approval.created_by not in creator_emails:
                    ...
                    logger.info(f"Completion notification for creator {approval.created_by}: {subject}")
    ...
    async def _send_via_external_service(
        ...
        message: str,
        approval: Approval,
        participant: Optional[ApprovalParticipant] = None
    ) -> bool:
