...
class TestAPIIntegration:
    ...
    async def test_pagination(self, client: AsyncClient):
        ...
        page1_ids = {inst["learner_id"] for inst in page1["instances"]}
        page2_ids = {inst["learner_id"] for inst in page2["instances"]}
